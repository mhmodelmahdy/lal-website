...
export default function AdminLoginPage({ params }) {
    // This is a client component, extract lang from URL
    ...
    // Extract lang from the pathname
    ...
    const handleLogin = (e) => {
        ...
        setTimeout(() => {
            if (user === "admin" && pass === "lal2024") {
                sessionStorage.setItem("lal_admin", "true");
                ...
                <div className="bg-white border border-gray-100 rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-navy-dark to-navy p-6 text-center">
                        <motion.div
                            ...
                            className="mx-auto w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center mb-3"
                        >
